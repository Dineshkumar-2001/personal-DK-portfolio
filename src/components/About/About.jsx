            ...
            <div className="lg:w-5/12 text-white space-y-6 mb-8 lg:mb-0">
              <div data-aos="fade-up">
                ...
                <p className="text-[#333] font-poppins font-medium lg:text-base text-sm">
                  I am a full-stack web developer skilled in JavaScript, React, Next.js, Redux, Node.js, Express, SQL, MongoDB, HTML, CSS, and Git.
                  A quick learner and team player, I am passionate about building responsive,
                  interactive web applications and continually expanding my expertise.
                </p>
              </div>
