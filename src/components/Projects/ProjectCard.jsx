      ...
      <div className="text-white border-0 border-white-transparent rounded-b-xl hover:bg-custom-text   mt-0 bg-[rgba(255,255,255,0.8)] py-6 px-4">
        ...
        {technologyStack && (
          <div className="text-left  font-poppins mt-0 mb-8 md:mb-2">
            ...
            {technologyStack.project_title && <p className="font-medium text-black text-base">Project title : <span className="text-[#161616] text-sm font-medium">{technologyStack.project_title}</span> </p>}
            {technologyStack.project_details && <p className="font-medium text-black text-base">Project summary : <span className="text-[#161616] text-sm font-medium">{technologyStack.project_details}</span> </p>}
