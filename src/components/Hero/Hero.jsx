...
const TypewriterEffect = () => {
  const sequences = ["Dinesh kumar", "Frontend Developer"]; // Words to display
        ...
        <div className="grid grid-cols-1 sm:grid-cols-12 items-center">
          <div data-aos="fade-right" className="col-span-1 sm:col-span-7">
            ...
            <p className="text-white text-base text-center lg:text-left sm:text-lg mb-6 lg:text-xl">
              Hi, I&apos;m Dinesh kumar. I am Fullstack Developer. <br />
              I have totally 2+ year experience In frontend developer using REACT TECHNOLOGY.
            </p>
